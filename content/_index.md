  ...
  - section_id: features
    ...
    features:
      - title: Modeling supernovae made easy
        ...
        content: >-
          With [tardis](https://tardis-sn.github.io/tardis) (our Monte Carlo radiative-transfer code), you can control simulation parameters and access physical properties of the model in an intuitive way.
        actions:
          - label: Learn More
      ...
      - title: Atomic data ready to use
        ...
        content: >-
          Our [carsus](https://tardis-sn.github.io/carsus) package can read atomic data from a variety of sources and output them to file formats readable by tardis and other radiative transfer codes.
        actions:
          - label: Learn More
